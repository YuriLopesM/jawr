...
export default function Curators() {
  return (
    <main className="w-full h-full flex flex-col gap-5">
      <header>
        <h1 className="text-base text-gray-800 font-bold dark:text-[#f0f0f0]">curadores</h1>
        <Divider />
      </header>
      <p className="text-sm text-gray-600 dark:text-[#b0b0b0]">as pessoas por trás da programação da jawr.</p>
      <ul className="flex flex-col gap-6">
        <li className="flex flex-col gap-2">
          <span className="flex items-center gap-2">
            <span className="text-sm font-bold text-gray-800 dark:text-[#f0f0f0]">ernest</span>
            <span className="text-xs px-1 py-px rounded border-[0.5px] border-emerald-600 text-emerald-700 dark:border-emerald-400 dark:text-emerald-400">curador</span>
            <span className="text-xs px-1 py-px rounded border-[0.5px] border-blue-600 text-blue-700 dark:border-blue-400 dark:text-blue-400">dev</span>
          </span>
