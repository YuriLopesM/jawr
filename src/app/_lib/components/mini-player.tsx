...
export function MiniPlayer() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex items-center gap-2 bg-white dark:tk-surface border border-gray-200 dark:tk-border shadow-sm text-xs text-gray-700 dark:tk-body max-w-70">
      {song?.art && (
