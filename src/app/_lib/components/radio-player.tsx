        ...
        <div className="flex flex-col justify-between h-full sm:col-start-1 sm:row-start-1">
              ...
              {playing && (
                <span className="inline-flex gap-0.5 items-end shrink-0">
                  {(
                    ...
                    <span
                      key={i}
                      className="w-1 h-3.5 bg-gray-500 dark:tk-bg-muted"
                      style={{
          ...
          <div className="flex flex-col gap-3 mb-2 mt-6 text-sm">
            ...
            {song?.artist && (
              <button
                ...
                className="text-xs text-gray-400 dark:tk-muted underline hover:text-gray-600 dark:hover:tk-body transition-colors text-left cursor-pointer w-fit"
              >
          ...
          <div className="mt-8 flex items-center justify-between">
            <button
              ...
              className="self-start text-xs text-gray-400 dark:tk-muted underline hover:text-gray-700 dark:hover:tk-body transition-colors cursor-pointer"
            >
            ...
            {session ? (
              ...
              <span className="text-xs text-gray-400 dark:tk-muted flex items-center gap-1.5">
                ...
                <button
                  onClick={confirm}
                  className="underline hover:text-gray-900 dark:hover:tk-heading transition-colors cursor-pointer"
                >
                  {t('lastfm_confirm')}
                </button>
              </span>
              ...
              <button
                onClick={connect}
                className="flex items-center gap-1.5 text-xs text-gray-400 dark:tk-muted hover:text-gray-900 dark:hover:tk-heading transition-colors cursor-pointer"
              >
