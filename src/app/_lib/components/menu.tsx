...
function MenuItem({ children }: MenuItemProps) {
  return (
    <span className="text-sm flex items-center cursor-pointer transition-colors text-gray-400 hover:text-gray-600 hover:font-medium dark:tk-muted dark:hover:tk-accent">
      [{children}]
    </span>
  );
}
